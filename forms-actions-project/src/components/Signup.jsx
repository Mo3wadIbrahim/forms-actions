    ...
    <form action={formAction}>
      ...
      <div className="control">
        ...
        <input
          ...
          type="email"
          name="email"
          defaultValue={formState.entredValues?.enteredEmail}
        />
      </div>
      ...
      <div className="control-row">
        <div className="control">
          ...
          <input
            ...
            type="password"
            name="password"
            defaultValue={formState.entredValues?.enteredPassword}
          />
        </div>
        ...
        <div className="control">
          ...
          <input
            ...
            defaultValue={formState.entredValues?.enteredConfirmPassword}
          />
        </div>
      </div>
      ...
      <div className="control-row">
        <div className="control">
          ...
          <input
            ...
            id="first-name"
            name="first-name"
            defaultValue={formState.entredValues?.enteredFirstName}
          />
        </div>
        ...
        <div className="control">
          ...
          <input
            ...
            id="last-name"
            name="last-name"
            defaultValue={formState.entredValues?.enteredLastName}
          />
        </div>
      </div>
      ...
      <div className="control">
        ...
        <select
          id="role"
          name="role"
          defaultValue={formState.entredValues?.enteredRole}
        >
      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="google"
            defaultChecked={formState.entredValues?.enteredAcquisition.includes(
              "google",
            )}
          />
      ...
      <div className="control">
        <label htmlFor="terms-and-conditions">
          <input
            ...
            name="terms"
            defaultChecked={formState.entredValues?.acceptedTerms}
          />
